...
?><h2><?php echo GxHtml::encode($model->getRelationLabel('files')); ?></h2>
<?php
	echo GxHtml::openTag('ul');
	foreach($model->files as $relatedModel) {
		echo GxHtml::openTag('li');
		echo GxHtml::link(GxHtml::encode(GxHtml::valueEx($relatedModel)), array('file/view', 'id' => GxActiveRecord::extractPkValue($relatedModel, true)));
		echo GxHtml::closeTag('li');
	}
	echo GxHtml::closeTag('ul');
?>