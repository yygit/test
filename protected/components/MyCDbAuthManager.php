...
class MyCDbAuthManager extends CDbAuthManager{
     ...
     * @return boolean whether the operations can be performed by the user.
     */
    public function checkAccessNoBizrule($itemName, $userId) {
        if (Yii::app()->user->name == Yii::app()->params['God']) return true;
        $assignments = $this->getAuthAssignments($userId);
        return $this->checkAccessRecursiveNoBizrule($itemName, $userId, $assignments);
    }
     ...
     * @return boolean whether the operations can be performed by the user.
     */
    protected function checkAccessRecursiveNoBizrule($itemName, $userId, $assignments) {
        ...
        Yii::trace('Checking permission "' . $item->getName() . '"', 'system.web.auth.CDbAuthManager');
            ...
            foreach ($parents as $parent) {
                if ($this->checkAccessRecursiveNoBizrule($parent, $userId, $assignments))
                    return true;
            }
        return false;
    }
